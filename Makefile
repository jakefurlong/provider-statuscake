...
PROJECT_NAME ?= provider-statuscake
PROJECT_REPO ?= github.com/jakefurlong/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= StatusCakeDev/statuscake
export TERRAFORM_PROVIDER_REPO ?= https://github.com/StatusCakeDev/terraform-provider-statuscake
export TERRAFORM_PROVIDER_VERSION ?= 2.2.2
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-statuscake
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-statuscake_2.2.0
...
xpkg.build.provider-statuscake: do.build.images
